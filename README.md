...
<div>
    ...
    <p style="text-indent: 20px;">-дорабатывается класс среды работы (приостановлено, завершено на 90%)</p> 
    <p style="text-indent: 20px;">-создается оболочка GUI (приостановлено, завершено на 5-10%)</p>
