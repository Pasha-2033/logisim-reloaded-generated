    ...
    public static void drawshadows(int dx, int dy){
        if (SettingsManager.griding()){
            if (WorkEnvironmentMain.wireoder){
                if (dx >= 0){
                    WorkEnvironmentMain.wireShadow[0] = new wire(0, 0, dx - dx % 10, 0, false);
                    ...
                    if (dx % 10 != 0){
                        WorkEnvironmentMain.wireShadow[0] = new wire(0, 0, Math.abs(dx - (10 + dx % 10)), 0, false);
                        ...
                        WorkEnvironmentMain.wireShadow[0] = new wire(0, 0, Math.abs(dx), 0, false);
                ...
                if (dy >= 0){
                    WorkEnvironmentMain.wireShadow[1] = new wire(0, 0, 0, dy - dy % 10, false);
                    if (dx >= 0){
                    ...
                    WorkEnvironmentMain.wireShadow[1] = new wire(0, 0, 0, Math.abs(dy - dy % 10), false);
                    if (dx >= 0){
                ...
                if (dy >= 0){
                    WorkEnvironmentMain.wireShadow[0] = new wire(0, 0, 0, dy - dy % 10, false);
                    WorkEnvironmentMain.wireShadow[0].setComponentLocation(WorkEnvironmentMain.portforwireshadow.location[0] - WorkEnvironmentMain.portforwireshadow.belongsto.getRotationFlag()[0] + WorkEnvironmentMain.portforwireshadow.belongsto.getComponentLocation()[0], WorkEnvironmentMain.portforwireshadow.location[1] - WorkEnvironmentMain.portforwireshadow.belongsto.getRotationFlag()[1] + WorkEnvironmentMain.portforwireshadow.belongsto.getComponentLocation()[1]);
                } else {
                    WorkEnvironmentMain.wireShadow[0] = new wire(0, 0, 0, Math.abs(dy - dy % 10), false);
                ...
                if (dx >= 0){
                    if (dy >= 0){
                        WorkEnvironmentMain.wireShadow[1] = new wire(0, 0, dx - dx % 10, 0, false);
                    ...
                    if (dy >= 0){
                        WorkEnvironmentMain.wireShadow[1] = new wire(0, 0, Math.abs(dx - dx % 10), 0, false);
            ...
            if (WorkEnvironmentMain.wireoder){
                if (dx >= 0){
                    WorkEnvironmentMain.wireShadow[0] = new wire(0, 0, dx, 0, false);
                    WorkEnvironmentMain.wireShadow[0].setComponentLocation(WorkEnvironmentMain.portforwireshadow.location[0] - WorkEnvironmentMain.portforwireshadow.belongsto.getRotationFlag()[0] + WorkEnvironmentMain.portforwireshadow.belongsto.getComponentLocation()[0], WorkEnvironmentMain.portforwireshadow.location[1] - WorkEnvironmentMain.portforwireshadow.belongsto.getRotationFlag()[1] + WorkEnvironmentMain.portforwireshadow.belongsto.getComponentLocation()[1]);
                } else {
                    WorkEnvironmentMain.wireShadow[0] = new wire(0, 0, Math.abs(dx), 0, false);
                ...
                if (dy >= 0){
                    WorkEnvironmentMain.wireShadow[1] = new wire(0, 0, 0, dy,false);
                    if (dx >= 0){
                    ...
                    WorkEnvironmentMain.wireShadow[1] = new wire(0, 0, 0, Math.abs(dy), false);
                    if (dx >= 0){
                ...
                if (dy >= 0){
                    WorkEnvironmentMain.wireShadow[0] = new wire(0, 0, 0, dy, false);
                    WorkEnvironmentMain.wireShadow[0].setComponentLocation(WorkEnvironmentMain.portforwireshadow.location[0] - WorkEnvironmentMain.portforwireshadow.belongsto.getRotationFlag()[0] + WorkEnvironmentMain.portforwireshadow.belongsto.getComponentLocation()[0], WorkEnvironmentMain.portforwireshadow.location[1] - WorkEnvironmentMain.portforwireshadow.belongsto.getRotationFlag()[1] + WorkEnvironmentMain.portforwireshadow.belongsto.getComponentLocation()[1]);
                } else {
                ...
                if (dx >= 0){
                    if (dy >= 0){
                        WorkEnvironmentMain.wireShadow[1] = new wire(0, 0, dx, 0, false);
                    ...
                    if (dy >= 0){
                        WorkEnvironmentMain.wireShadow[1] = new wire(0, 0, Math.abs(dx), 0, false);
