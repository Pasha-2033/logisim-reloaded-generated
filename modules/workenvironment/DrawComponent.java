...
public class DrawComponent {
    ...
    private void drawrect(Component component, Graphics graphics, float Scale, Object[] RectData){
        ...
        (new DrawMethods()).drawRect(graphics, location, arg1, arg2, Math.round((int) RectData[3] * Scale), Math.round((int) RectData[4] * Scale), (Color) RectData[5], stroke, component.rotation);
    }
    ...
    private void drawoval(Component component, Graphics graphics, float Scale, Object[] OvalData){
        ...
        (new DrawMethods()).drawOval(graphics, location, arg1, arg2, Math.round((int) OvalData[3] * Scale), Math.round((int) OvalData[4] * Scale), (Color) OvalData[5], stroke, component.rotation);
    }
